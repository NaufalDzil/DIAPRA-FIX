                          ...
                          <form action="{{ route('sppd.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" value="{{old('nama')}}" name="nama" class="form-control" placeholder="Nama/NIP" required>
                                @if($errors->has('nama'))
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" value="{{old('maksud')}}" name="maksud" class="form-control" placeholder="Maksud Perjalanan Dinas" required>
                            ...
                            <div class="form-group">
                              ...
                              <input type="date" value="{{old('tanggal_kembali')}}" name="tanggal_kembali" class="form-control" required>
                            </div>
                            
                            <div class="form-group">
                              <label>Keterangan :</label>
                              <input type="text" name="ket" value="{{old('ket')}}" class="form-control" placeholder="Keterangan">
                              @if($errors->has('ket'))
                              <div class="text-danger">
                                {{ $errors->first('ket')}}
                                </div>
