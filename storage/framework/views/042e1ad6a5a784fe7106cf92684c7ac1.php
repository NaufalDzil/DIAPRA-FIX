                        ...
                        <div class="card card-primary">
                          ...
                          <form action="<?php echo e(route('st.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <input type="date" name="tanggal" value="<?php echo e(old('tanggal')); ?>" class="form-control" required>
                            </div>

                            <div class="form-group">
                              <label>Nama/NIP : <b class="text-danger">*</b></label>
                              <input type="text" name="nama" value="<?php echo e(old('nama')); ?>" class="form-control" placeholder="Nama/NIP" required>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="maksud" value="<?php echo e(old('maksud')); ?>" class="form-control" placeholder="Maksud Perjalanan Dinas" required>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" value="<?php echo e(old('lamanya')); ?>" name="lamanya" class="form-control" placeholder="Lamanya" required>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" value="<?php echo e(old('ket')); ?>" name="ket" class="form-control" placeholder="Keterangan">
...
<?php endif; ?><?php /**PATH D:\Kuliah\Magang\Web\WEB LAST\DIAPRA\resources\views\st\create.blade.php ENDPATH**/ ?>