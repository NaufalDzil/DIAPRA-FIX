                        ...
                        <div class="card card-primary">
                          ...
                          <form action="<?php echo e(route('nodin.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" value="<?php echo e(old('alamat')); ?>" name="alamat" class="form-control" placeholder="Alamat Penerima" required>
                            ...
                            <div class="form-group">
                              ...
                              <input type="date" value="<?php echo e(old('tangggal_surat')); ?>" name="tanggal_surat" class="form-control" required>
                            </div>
