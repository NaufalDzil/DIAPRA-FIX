                        ...
                        <div class="card card-primary">
                          ...
                          <form action="<?php echo e(route('suratkeluar.update', $suratkeluar->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                              <div class="form-group">
                                <div class="form-group">
                                  ...
                                  <label>Nomor :</label>
                                  <input type="text" class="form-control" value="<?php echo e($suratkeluar->id); ?>" readonly>
                              </div>

                                <label>Nomor Surat : <b class="text-danger">*</b></label>
                                <input type="text" placeholder="Nomor Surat" name="nomor_surat" class="form-control" value="<?php echo e($suratkeluar->nomor_surat); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Tujuan Surat" name="alamat" class="form-control" value="<?php echo e($suratkeluar->alamat); ?>" required>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" placeholder="Perihal" name="perihal" class="form-control" value="<?php echo e($suratkeluar->perihal); ?>" required>
...
<?php endif; ?><?php /**PATH D:\Kuliah\Magang\Web\WEB LAST\DIAPRA\resources\views\suratkeluar\edit.blade.php ENDPATH**/ ?>