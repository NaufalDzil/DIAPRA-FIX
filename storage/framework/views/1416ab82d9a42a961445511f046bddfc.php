                          ...
                          <form action="<?php echo e(route('sisipan.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="no" class="form-control" placeholder="Nomor" value="<?php echo e(old('no')); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nomor_surat" class="form-control" value="<?php echo e(old('nomor_surat')); ?>" placeholder="Nomor Surat" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat" class="form-control" value="<?php echo e(old('alamat')); ?>" placeholder="Tujuan Surat" required>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="perihal" class="form-control" value="<?php echo e(old('perihal')); ?>" placeholder="Perihal" required>
...
<?php endif; ?><?php /**PATH D:\Kuliah\Magang\Web\WEB LAST\DIAPRA\resources\views\sisipan\create.blade.php ENDPATH**/ ?>